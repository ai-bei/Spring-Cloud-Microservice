    ...
    */
    ...
    public HouseInfo getData(@RequestParam("name") String name) {
        return restTemplate.getForObject(
                "http://ribbon-loadStrategy/house/data?name="+name, HouseInfo.class);
    }

    @GetMapping("/call/data/{name}")
    public String getData2(@PathVariable("name") String name) {
        return restTemplate.getForObject(
                "http://ribbon-loadStrategy/house/data/{name}", String.class, name);
    }
    ...
    public Long add() {
        ...
        Long id = restTemplate.postForObject(
                "http://ribbon-loadStrategy/house/save", houseInfo, Long.class);
        return id;
    }
